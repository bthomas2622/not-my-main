export default {
  Ash: {
    lines: ["See your imperfections in your enemies, then crush them.",
  ...
  Ballistic: {
    lines: ["I'm the jumpmaster. I won't let you down, except by falling.",
      ...
      "I'm the jumpmaster. I'll take care of you.",
      "I'm the jumpmaster. I won't let you down.",
      "I'm the jumpmaster. I won't let you down, except by falling."],
    class: "assault"
  },
  Bangalore: {
    lines: ["Nothing like cold steel on a hot day.",
  ...
  Caustic: {
    lines: ["Death is not mercurial. It's patient... unlike life.",
  ...
  Crypto: {
    lines: ["It's hard to be scared when you're prepared.",
  ...
  Fuse: {
    lines: ["Been puttin' the 'bomb' in bombastic since 2681.",
  ...
  Gibraltar: {
    lines: ["Alright, pal, let's go change a life.",
      "Come and get it.",
  ...
  Horizon: {
    lines: ["Time for experimentation, evaluation and a wee cuppa tea.",
  ...
  Lifeline: {
    lines: ["Get ready... today's not gon' be easy.",
  ...
  Loba: {
    lines: ["Enough flirting, save it for when we win.",
  ...
  Mad_Maggie: {
    lines: ["Ya can't spell 'problematic' without 'M.E'.",
  ...
  Mirage: {
    lines: ["Alright, either you're with me or you're against me, or you're with me and against me, cause I'll be honest, that happens sometimes.",
  ...
  Newcastle: {
    lines: ["As long as you're near me, you're safe.",
  ...
  Octane: {
    lines: ["Reckless and full of wrecks. Let's go!",
  ...
  Pathfinder: {
    lines: ["I cannot wait to win this match, friend!",
  ...
  Rampart: {
    lines: ["Oh, ain't nothing better than waiting!... Except for bloody everything else.",
  ...
  Seer: {
    lines: ["Do not hide your true colors. They are your strength.",
  ...
  Valkyrie: {
    lines: ["Ever feel the freedom of soaring through the sky? Do you wanna?",
      "FLY. FIGHT. WIN.",
  ...
  Wattson: {
    lines: ["All it takes is a single spark.",
      "Charged and ready.",
  ...
  Wraith: {
    lines: ["My name is Wraith - and we have a job to do.",
